...
```
SOC & Threat Detection    →  Splunk SIEM, log analysis, alert triage
...
- **Google Cybersecurity Professional** — Coursera, Dec 2025 · [Verify](https://www.coursera.org/account/accomplishments/specialization/2DMTDIPKA082)
- **TryHackMe Pre Security** — Jul 2025 · [Verify](https://tryhackme-certificates.s3-eu-west-1.amazonaws.com/THM-64MO7YF4NT.pdf)
- **30-Days SOC Challenge** — HAXCAMP, Aug 2026 · [Verify](https://mktzkjdxvmxurlcmakux.supabase.co/storage/v1/object/public/certificates/certificate-2336.pdf)
